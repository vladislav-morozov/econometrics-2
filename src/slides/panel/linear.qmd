...
What about beyond one-way effects? Usually impose an assumption that covers all cases —  <span class="highlight"> panel data version of strict exogeneity </span> is imposed:
...
#### Inference with FE Estimators

- s

#### Some Further Comments

Some minor technical points (not examinable)

- Within transformation can create dependence (e.g. in two-way transformation )
- Technically distribution of $\tilde{\bX}_{it}$ changing with $N$
- That's not a problem and does not affect asymptotics
