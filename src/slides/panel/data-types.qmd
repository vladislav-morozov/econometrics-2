...
format:
  revealjs:
    include-in-header: 
      text: |
        <meta name="description" content="Explore different data types: cross-sectional, time series, panel, and repeated cross-sectional data classifications (lecture notes slides)."/> 
    width: 1150
    slide-number: true
    sc-sb-title: true
    incremental: true   
...
open-graph:
    description: "Explore different data types: cross-sectional, time series, panel, and repeated cross-sectional data classifications (lecture notes slides)."
---
...
#| fig-alt: "Visualizing cross-sectional data"
# Extract data
