...
Let's return to the OLS estimator
$$
...
We make all the assumptions for consistency
...
- $N^{-1}\sum_{i=1}^N \bX_i U_i$ — sum of IID random variable with $\E[\bX_i U_i]=0$.
...
- Variance expression in @prp-vector-distribution-ols-distr is sometimes called the "sandwich" form
