...
The "or" allows the possibility that <span class="highlight">both</span> $\beta_3\neq 0$ and $\beta_4\neq 0$


:::


#### Potentially Multiple Linear Hypotheses

<div class="rounded-box">

Needs tests that can handle multiple restrictions
