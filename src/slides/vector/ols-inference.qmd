...
#### $t$-Statistic under $H_1$: Consistency
...
$\Rightarrow$ In general need to something transform $\bR\hat{\bbeta}-\bq$ to get $\bI_k$ asymptotic variance

#### Standardizing a Normal Vector
