...
Our last remaining goal: convenient expression for the OLS estimator
...
You can differentiate with respect to the whole vector $\bbeta$ to get the same result, see [Wikipedia](https://en.wikipedia.org/wiki/Matrix_calculus#Scalar-by-vector)
:::
