...
- But each fold fits only with $(k-1)N_{Tr}/k$ example
...
- In parallel: e.g. simple averages (as in random forest regressions)
...
A random forest is a predictor that aggregates many tree predi
...
This looks a lot more cheerful
