...
#### Reminder: Preprocessing Pipeline


#### `LinearRegression`

`LinearRegression` from `sklearn` implements OLS (and some versions)
...
- OLS with given maximum rank, maybe not too high?
  - How to select polynomial degree? 
- Or penalized with a generous
  - Penalized by how much? Does it matter 


#### Model Selection

These are all model selection problems 
...
`LaasoCV` and `RidgeCV` automatically select their 
