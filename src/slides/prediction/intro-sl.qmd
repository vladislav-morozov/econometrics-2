...
### Learning Scenarios {background="#43464B" visibility="uncounted"}
...
## Components of a Prediction Problem {background="#00100F"}

#### Overall Anatomy of Prediction

Overall anatomy quite simple: 

- Formulate the question: what do we care about?
- Get data
- Fit model  
- Test performance
- Use
...
Overall goal: "good prediction" (generalization)
...
One exception: transductive inference
