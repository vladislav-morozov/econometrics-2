...
subtitle: "MSE, Train-Test Split, and Exploratory Analysis in Practice"
...
- Some patterns due to presence of places with large prison
  - We will keep those observations
  - Retry analysis with dropping them from the training set
...
- For training want <span class="highlight"
...
- Creating new variables (bedroom ratio in our case)
- Scaling for all variables
