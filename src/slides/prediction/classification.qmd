...
`LogisticRegression` in `scikit-learn` automatically is multi-class by default. Trained example the same way
```{python}
#| echo: true
logit = Pipeline(
  [
...
Can also use pairwise precisions, recalls, ROC curves etc. 
